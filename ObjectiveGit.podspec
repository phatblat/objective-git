Pod::Spec.new do |s|
  ...
  s.authors       =  { "Tim Clem" => "timothy.clem@gmail.com", "Josh Abernathy" => "josh@github.com" }
  s.source        =  { :git => "https://github.com/libgit2/objective-git.git", :tag => s.version.to_s, :submodules => false }
